    ...
    <>
          <div className="container" style={{color: props.mode ==='dark' ? 'white' : '#042743'}}>
            ...
            <div className="mb-3">
              ...
              <textarea className="form-control" value={text} onChange={handleonChange} id="box" rows="3" style={{backgroundColor: props.mode ==='dark' ? '#0080ff' : 'white', color: props.mode ==='dark' ? 'white' : '#042743'}}></textarea>
            </div>
